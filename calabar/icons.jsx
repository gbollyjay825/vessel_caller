/* global React */
// ============================================================
// Icon — thin line icons, 20px default, inherit currentColor.
// Lucide-style paths, stroke-width 1.75 to read "thin".
// ============================================================
const ICON_PATHS = {
  ...
  fileText: '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7z"/><path d="M14 2v5h5"/><line x1="9" x2="15" y1="13" y2="13"/><line x1="9" x2="15" y1="17" y2="17"/>',
...
function Icon({ name, size = 20, strokeWidth = 1.75, className = '', style = {} }) {
  ...
  return (
    <svg
      ...
      className={'ico ' + className} style={style} aria-hidden="true"
